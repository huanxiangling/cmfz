...
//                            // jqgrid重新载入
    ...
    function exportModel() {
        location.href="${pageContext.request.contextPath}/banner/exportModel";
    }
</script>
<!--中心内容-->
<div id="content">
                    ...
                    <div class="col-md-12 column">
                        <div class="tabbable" id="tabs-109847">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#panel-365123" data-toggle="tab">轮播图信息</a>
                                </li>
                                <li>
                                    <a href="#" onclick="bannerEx()" data-toggle="tab">导出轮播图信息</a>
                                </li>
                                <li>
                                    <a href="#" onclick="exportModel()" data-toggle="tab">导出轮播图模板</a>
                                </li>
                                <li>
                                    <a href="#"  data-toggle="modal" data-target="#myModal">导入轮播图信息</a>
                                </li>
                            </ul>
